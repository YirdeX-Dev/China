...
["Rebel"] = "反叛",
["Peabert ESP"] = "狗哥透视",
["Highlights PEABERT through walls"] = "透视墙壁高亮狗哥",
["Balloon ESP"] = "气球透视",
["Highlights all Balloons through walls"] = "透视墙壁高亮所有气球",
["TP to Balloon"] = "传送至气球",
["Teleports to the nearest balloon"] = "传送至最近的气球",
["Auto Balance"] = "自动平衡",
["Auto Jump (BETA)"] = "自动跳跃 (测试版)",
["Jumps over the rope automatically"] = "自动跳过绳索",
["Rope Godmode (BETA)"] = "绳索无敌模式 (测试版)",
["the rope will not do anything and you can walk through it."] = "绳索将失去作用，你可以直接穿过它。",
["Infinite Stamina"] = "无限体力",
["Always keeps you at full stamina no need to get hit first. Works only when you're a Hider."] = "始终保持满体力，无需先被击中。仅当你是躲藏者时生效。",
